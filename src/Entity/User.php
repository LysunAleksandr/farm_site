...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=RentBeds::class, mappedBy="Ðrenter")
     */
    private $rentBeds;
    ...
    /**
     * @ORM\OneToMany(targetEntity=Plant::class, mappedBy="users")
     */
    private $plants;
